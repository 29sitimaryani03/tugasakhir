                ...
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <tbody>
                                @forelse($list_cart as $cart)
                                    <tr>
                                            ...
                                            <div class="product">
                                                <figure class="product-media">
                                                    <a href="{{ url('product', $cart->id_produk) }}">
                                                        @if ($cart->produk)
                                                            <img src="{{ url('public') }}/{{ $cart->produk->thumbnail_produk }}"
                                                                alt="Product image">
                                                        @else
                                                            <img src="{{ url('public/default.png') }}"
                                                                alt="Default product image">
                                                            <!-- Default image if product is null -->
                                                        @endif
                                                    </a>
                                                </figure>
                                                <h3 class="product-title">
                                                    <a
                                                        href="{{ url('product', $cart->id_produk) }}">{{ $cart->produk ? $cart->produk->nama_produk : 'Product not found' }}</a>
                                        ...
                                        <td class="quantity-col">
                                            <div class="cart-product-quantity">
                                                <input type="number" class="form-control"
                                                    value="{{ $cart->banyak_produk }}" min="1" max="10"
                                        ...
                                        <td>
                                            <a href="{{ url('checkout', $cart->id) }}"
                                                class="btn btn-outline-primary-2 btn-order ml-5 mr-0">BELI</a>
                                        </td>
                                        <td>
                        ...
                        <div class="cart-bottom">
                            <a href="{{ url('shop') }}" class="btn btn-outline-dark-2"><span>Lanjut Belanja</span><i
