                        ...
                        <div class="product-gallery product-gallery-vertical">
                            <div class="row">
                                <figure class="product-main-image">
                                    <img id="product-zoom" src="{{ url('public') }}/{{ $produk->galeri[0]->gambar }}"
                                        alt="product image">
                                ...
                                <div id="product-zoom-gallery" class="product-image-gallery">
                                    @foreach ($produk->galeri as $carousel)
                                        <a href="#" class="mb-1"
                                            data-image="{{ url('public') }}/{{ $carousel->gambar }}"
                                            data-zoom-image="{{ url('public') }}/{{ $carousel->gambar }}">
                            ...
                            <form action="{{ url('add_to_cart') }}" method="post">
                                ...
                                <div class="details-filter-row details-row-size">
                                    ...
                                    <div class="product-details-quantity">
                                        <input type="number" id="qty" name="banyak_produk" class="form-control"
