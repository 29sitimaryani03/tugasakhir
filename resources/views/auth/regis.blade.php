                    ...
                    <div class="form-box">
                        <div class="form-tab">
                            <ul class="nav nav-pills nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" id="signin-tab-2" href="{{ url('login') }}" role="tab" aria-controls="signin-2" aria-selected="true">Login</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="tab-pane fade show active" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
                                    ...
                                    <form action="{{ url('regis') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="register-email-2" name="nama" required>
                                            @error('nama')
                                        ...
                                        <div class="form-group">
                                            <label for="register-email-2">Email Anda *</label>
                                        ...
                                        <div class="form-group">
                                            <label for="register-email-2">NO. Handphone *</label>
                                            <input type="number" class="form-control" id="register-email-2" name="no_hp" required>
                                            @error('no_hp')
                                            <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                            @enderror
                                        </div><!-- End .form-group -->
                                        ...
                                        <div class="form-group">
                                            <label for="register-password-2">Konfirmasi Password *</label>
