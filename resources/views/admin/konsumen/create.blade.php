                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <form action="{{ url('admin/konsumen/store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <x-input.input label="Nama" type="text" name="nama"
                                            placeholder="Masukan nama konsumen ..." />
                                    </div>
                                    <div class="col-md-4">
                                        <x-input.input label="Telepon" type="text" name="tlp"
                                            placeholder="Masukan telepon konsumen ..." />
                                    </div>
                                    <div class="col-md-4">
                                        <x-input.input label="Email" type="text" name="email"
                                    ...
                                    <div class="col-md-6">
                                        <x-input.input label="Alamat" type="text" name="alamat"
